...
// import { faBars, faUsersViewfinder, faBriefcase, faBox, faEnvelope, faPaperPlane } from '@fortawesome/free-solid-svg-icons';
...
//     { id: 4, name: 'Contactenos', icon: faEnvelope, activeIcon: faPaperPlane  },
//   ];
